...
export default function SignupPage() {
  ...
  const isStrongPassword = (pw) => pw.length >= 7 && /[^a-zA-Z0-9]/.test(pw);
  ...
  const handleSignup = async (e) => {
    ...
    if (!isValidUsername(username)) {
      setError('Invalid username. Use 3–15 characters with letters, numbers, or underscores. Offensive or restricted names are not allowed.');
      return;
    }
