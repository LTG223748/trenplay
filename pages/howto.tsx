...
const HowToUsePage = () => (
  <div
    id="how-to-use"
    className="min-h-screen bg-gradient-to-br from-[#0e0020] via-[#1a0030] to-[#0a001a] text-white px-6 py-10 font-futuristic scroll-mt-16 md:scroll-mt-24"
  >
    ...
    <div className="space-y-12 max-w-3xl mx-auto">
      ...
      <section>
        ...
        <ul className="list-disc ml-6 space-y-2 text-lg">
          ...
          <li>As soon as both users confirm the winner, coins are released <span className="text-green-400">automatically to the winner</span>.</li>
          <li>A <span className="text-yellow-400">7% fee</span> is taken from the winner’s prize to support the platform.</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className="list-disc ml-6 space-y-2 text-lg">
          <li><span className="text-red-400 font-bold">No cheating allowed!</span> Anyone caught submitting fake results, lying about match outcomes, or trying to scam the system <span className="font-bold">will be banned.</span></li>
          <li>Users must play as the teams agreed upon in chat. Playing as a different team can void your match and forfeit your wager.</li>
          <li>Abusive or inappropriate chat/messages will result in penalties or bans.</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p className="text-lg">
          ...
          <br />
          Check out our{' '}
          <Link href="/help" className="underline text-yellow-400">Help</Link>
          {' '}page or email us at{' '}
          <a href="mailto:support@trenplay.net" className="underline text-yellow-300">
